...
// Where a field access begins, within the struct it reaches into. The resolver
// settled which field of which struct this is; how far into it that field sits
// is the layout's answer.
