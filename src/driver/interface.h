...
/* A compiled module's declarations as Gab source with no bodies: what a later compilation reads in
 * place of the source it was built from. Reading one back is parsing, so the format cannot drift from
