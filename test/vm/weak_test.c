...
static void test_a_self_referential_struct_declares() {
    assert(test_compiles("struct Node { parent: weak *Node, child: *Node }\n"));
...
static void test_a_weak_field_reads_and_writes() {
    assert(test_run_int("struct Node { n: int, parent: weak *Node }\n"
                        "func main(): int {\n"
                        "    let a: *Node = new Node;\n"
                        "    let b: *Node = new Node;\n"
                        "    a.n = 7;\n"
...
static void test_a_parent_child_cycle_frees_both() {
    assert(test_run_int("struct Node { n: int, parent: weak *Node, child: *Node }\n"
                        "func main(): int {\n"
